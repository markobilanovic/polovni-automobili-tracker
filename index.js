...
async function init() {
  ...
  try {
    ...
    await client.query(`insert into tasks (title, email, url, processedIds) values ('Peugeot 308', 'bilanovic90@gmail.com', 'https://www.polovniautomobili.com/auto-oglasi/pretraga?sort=tagValue131_asc&brand=peugeot&model%5B0%5D=308&year_from=2014&chassis%5B0%5D=2631&city_distance=0&showOldNew=all&without_price=1', ARRAY []`);
